...
device = ['light','CE appliance','fridge','waste disposal unit','dish washer']
input_path = '/aul/homes/qli027/projects/disaggregation/final_version/prepare_for_figures/occupancy/data/1min/VPN/'
output_path = '/aul/homes/qli027/projects/disaggregation/final_version/prepare_for_figures/occupancy/evaluation/VPN/'
for i in range(0,5):
    for model in models:
        if model == 'FHMM' :
