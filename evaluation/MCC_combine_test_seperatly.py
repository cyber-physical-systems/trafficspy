...
for house_num in range(3,9):
    ...
    for model in models:
        ...
        input_path =  '/aul/homes/qli027/projects/disaggregation/final_version/evaluation/MCC_test_seperately/' + str(house_num) + '/' + model + '.csv'


        output_path =  '/aul/homes/qli027/projects/disaggregation/final_version/evaluation/MCC_combine_test_seperately/'  + str(house_num) + '_' + model + '.csv'
...
for model in models: 
    house_num =3
    input_path = '/aul/homes/qli027/projects/disaggregation/final_version/evaluation/MCC_combine_test_seperately/'  + str(house_num) + '_' + model + '.csv'
    output_path =  '/aul/homes/qli027/projects/disaggregation/final_version/evaluation/MCC_combine_test_seperately/' + model + '.csv'
