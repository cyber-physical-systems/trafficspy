...
for house_num in range(3,9):
    ...
    output_path = '/aul/homes/qli027/projects/disaggregation/final_version/evaluation/F1_test_seperately/' + str(house_num) + '/'
    ...
    for model in models:
        ...
        for threshold in range(1000,295000,100):
            ...
            for device in devices :
                ...
                metric[device] = '{0:.6f}'.format(f1_score(gt_,pred_))
